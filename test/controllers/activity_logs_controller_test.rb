...
class ActivityLogsControllerTest < ActionController::TestCase
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post :create, activity_log: { activity: @activity_log.activity, mobile_user_id: @activity_log.mobile_user_id, status: @activity_log.status }
    end
  ...
  test "should update activity_log" do
    patch :update, id: @activity_log, activity_log: { activity: @activity_log.activity, mobile_user_id: @activity_log.mobile_user_id, status: @activity_log.status }
    assert_redirected_to activity_log_path(assigns(:activity_log))
  end
